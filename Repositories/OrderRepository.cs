...
public class OrderRepository : IOrderRepository {
    ...
    public async Task<GenericResponse<OrderEntity?>> CreateUpdateOrderDetail(OrderDetailCreateUpdateDto dto) {
        ProductEntity p = (await _dbContext.Set<ProductEntity>().Include(x => x.User)
        ...
        if (o is null) {
            ...
            EntityEntry<OrderDetailEntity> orderDetailEntity = await _dbContext.Set<OrderDetailEntity>().AddAsync(
        ...
        OrderDetailEntity? od = await _dbContext.Set<OrderDetailEntity>()
    ...
    public async Task<GenericResponse<OrderEntity?>> CreateReservationOrder(ReserveCreateUpdateDto dto) {
        ...
        EntityEntry<OrderEntity> orderEntity = await _dbContext.AddAsync(e);
    ...
    public async Task<GenericResponse<OrderEntity?>> ApplyDiscountCode(ApplyDiscountCodeOnOrderDto dto) {
        ...
        DiscountEntity? d = await _dbContext.Set<DiscountEntity>()
    ...
    public async Task<GenericResponse> Vote(OrderVoteDto dto) {
        OrderDetailEntity? orderDetail =
            await _dbContext.Set<OrderDetailEntity>().FirstOrDefaultAsync(f => f.Id == dto.Id);
